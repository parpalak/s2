...
'No XML support'				=>	'На этой установке PHP нет встроенной поддержки XML (функция xml_parser_create). Без нее не могут работать расширения S2. Обратитесь в техническую поддержку вашего хостинга.',
