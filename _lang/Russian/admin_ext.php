...
'Illegal ID'					=>	'ID расширения должен совпадать с названием директории расширения и состоять только из строчных английских букв или цифр (a-z, 0-9) или символа подчеркивания (_).',
