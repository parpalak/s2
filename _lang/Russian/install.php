...
'E-mail address help'		=>	'Адрес электронной почты <i>администратора</i>.<br />Если укажете, будете получать на него уведомления, когда кто-то оставляет комментарий. Этот адрес привязывается к вашей учетной записи и изменяется в ее настройке. Он никогда не отображается на сайте. Но его могут увидеть в панели управления другие пользователи, если вы им дадите такие права.<br />В процессе установки S2 значение этого поля будет присвоено адресу электронной почты <em>автора сайта</em>. Электронная почта автора сайта используется в RSS и в поле «от кого» при рассылке комментариев подписчикам. Поэтому ее адрес в принципе может попасть к спамерам. Электронная почта автора сайта может быть изменена позднее независимо от адресов электронной почты, связанных с учетными записями.',
