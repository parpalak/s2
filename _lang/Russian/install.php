...
'Part1 intro'				=>	'Введите информацию о базе данных, которую будет использовать S2. Вы должны узнать все параметры, запрашиваемые ниже. Обратитесь в техническую поддержку хостинга в случае каких-либо затруднений.',
...
'Database type info'		=>	'S2 может работать с базами данных MySQL, PostgreSQL и SQLite. В выпадающем списке ниже появятся только те базы данных, с которыми может работать PHP на этом сервере. Более полная информация о возможности использования конкретных версий баз данных есть в документации.',
...
'Database server info'		=>	'Введите адрес сервера базы данных (например, <em>localhost</em>, <em>mysql1.example.com</em> или <em>208.77.188.166</em>). Вы можете указать и порт, если сервер базы данных работает на нестандартном порте (например, <em>localhost:3580</em>). For SQLite support, just enter anything or leave it at \'localhost\'.',
