...
'No cache write'			=>	'<strong>Отсутствуют права на запись в папку _cache!</strong> Во время работы S2 пишет файлы в директорию <em>_cache</em>. Скрипты PHP должны обладать правами для создания файлов в этой директории. Измените разрешения на доступ к директории _cache командой chmod. Если не знаете, какие разрешения устанавливать, установите 0777.',
'No pictures write'			=>	'<strong>Отсутствуют права на запись в папку _pictures!</strong> S2 сохраняет загруженные картинки и другие файлы в директорию <em>_pictures</em>. Если вы планируете загружать картинки, убедитесь, что скрипты PHP обладают правами для создания файлов в этой директории. При необходимости измените разрешения на доступ к директории _pictures командой chmod. Если не знаете, какие разрешения устанавливать, установите 0777.',
