...
'Database name info'		=>	'Укажите название базы данных, в которой S2 будет хранить информацию. Эта база данных должна существовать. В случае SQLite это будет относительный путь к файлу базы данных. Если этот файл не существует, S2 попробует создать его.',
...
'Username too long'			=>	'Логин администратора содержит больше 25 символов. Вернитесь назад и выберите логин покороче.',
'Username too short'		=>	'Логин должен быть не короче двух символов. Вернитесь назад и выберите другой логин.',
'Password too long'			=>	'Пароль администратора содержит больше 25 символов. Вернитесь назад и придумайте пароль покороче.',
