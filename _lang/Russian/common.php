...
return array(
	...
	'Comment syntax info'    => 'Для выделения используйте следующий код: [i]<i>курсив</i>[/i], [b]<b>жирный</b>[/b].<br />Цитату оформляйте так: [q = имя автора]цитата[/q] или [q]еще цитата[/q].<br />Других команд или HTML-тегов здесь нет.',
