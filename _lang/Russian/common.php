...
'Show email label title'	=> 'Защита от спама на javascript.',
'Subscript label'			=> 'Подписаться на комментарии других посетителей',
'Subscript label title'		=> 'Комментарии других пользователей будут приходить вам по почте. Сможете отписаться, когда надоест.',
...
$lang_filesize = array('Б', 'КБ', 'МБ', 'ГБ', 'ТБ', 'ПБ', 'ЭБ', 'ЗБ', 'ИБ');
