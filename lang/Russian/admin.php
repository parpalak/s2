...
'Children preview'			=> 'Показывать анонсы дочерних страниц. Настройка важна только для разделов.', 
...
'URL empty'					=> 'Задайте URL, чтобы адрес этой страницы отличался от адреса раздела.',
