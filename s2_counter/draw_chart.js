...
$(function ()
{
	...
	$(document).on('stat_tab_loaded.s2', function ()
	{
		if (!hits)
		{
			hits = new SWFObject("../_extensions/s2_counter/amstock/amstock.swf", "amstock", "100%", "400px", "8", "#FFFFFF");
		...
		if (!rss)
		{
			rss = new SWFObject("../_extensions/s2_counter/amstock/amstock.swf", "amstock", "100%", "400px", "8", "#FFFFFF");
