...
?>
				<form target="submit_result" enctype="multipart/form-data" action="<?php echo S2_PATH; ?>/_admin/pict_ajax.php?action=upload" method="post" onsubmit="UploadSubmit(this);">
					...
					<?php printf($lang_pictures['Upload limit'], Lang::friendly_filesize(s2_return_bytes(ini_get('upload_max_filesize'))), Lang::friendly_filesize(s2_return_bytes(ini_get('post_max_size'))))?><br />
