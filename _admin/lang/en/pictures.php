...
'Directory not open'			=> 'Cannot read files in the folder <strong>%s</strong>.',
'Empty directory'				=> 'This folder is empty',
'Delete'						=> 'Delete',

// Error messages on file uploading
UPLOAD_ERR_INI_SIZE				=> 'The uploaded file exceeds the limit (upload_max_filesize directive in php.ini).',
UPLOAD_ERR_FORM_SIZE			=> 'The uploaded file exceeds the limit (MAX_FILE_SIZE directive that was specified in the HTML form).',
UPLOAD_ERR_PARTIAL				=> 'The uploaded file was only partially uploaded.',
UPLOAD_ERR_NO_FILE				=> 'No file was uploaded.',
UPLOAD_ERR_NO_TMP_DIR			=> 'Missing a temporary folder.',
UPLOAD_ERR_CANT_WRITE			=> 'Failed to write file to disk',
UPLOAD_ERR_EXTENSION			=> 'A PHP extension stopped the file upload.',
'Unknown error'					=> 'An error occured during upload.',
