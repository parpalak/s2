...
class DBLayer_MySQLi extends DBLayer_Abstract
{
    ...
    protected array $datatype_transformations = [
    ...
    public function __construct($db_host, $db_username, $db_password, $db_name, $db_prefix, $p_connect)
    {
        ...
        if (!function_exists('mysqli_connect')) {
            throw new Exception('This PHP environment doesn\'t have Improved MySQL (mysqli) support built in. Consult the PHP documentation for further assistance.');
        }
    ...
    function create_table($table_name, $schema, $no_prefix = false)
    {
        ...
        $query = substr($query, 0, -2) . "\n" . ') ENGINE = ' . ($schema['ENGINE'] ?? self::ENGINE) . ' CHARACTER SET utf8';
