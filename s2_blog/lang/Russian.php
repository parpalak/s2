...
'Blog URL'					=> 'URL блога',
'Blog URL label'			=> 'Префикс URL блога (слеш в&nbsp;начале нужен, в&nbsp;конце&nbsp;— нет). Например, «/blog». Можно оставить пустым, тогда блог будет сразу на главной.',
...
$lang_s2_blog_days = array('Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб', 'Вс');
